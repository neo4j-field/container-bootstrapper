...
/**D
 * Copy-Pasta of {@link org.neo4j.graphdb.factory.module.edition.CommunityEditionModule} but
 * with some tweaks specific to Linux containers.
 */
public class CommunityContainerEditionModule extends ContainerEditionModule {
    ...
    public CommunityContainerEditionModule(GlobalModule globalModule) {
        ...
        // XXX: This is the key part...we use our own SslPolicyLoader that supports a
        // container-friendly way of loading private keys and x509 certificates.
        // TODO: MAKE A CONTAINER-FRIENDLY SSL POLICY LOADER!!!
    ...
    // ***************
    // COPY PASTA FROM CommunityEditionModule
